...
local Library do
    ...
    local Themes = {
		["Preset"] = {
            ...
            ["Inline"] = Color3.fromRGB(20, 25, 30),
            ["Hovered Element"] = Color3.fromRGB(40, 50, 70),
            ["Page Background"] = Color3.fromRGB(15, 18, 22),
            ["Outline"] = Color3.fromRGB(50, 60, 80),
            ["Element"] = Color3.fromRGB(25, 30, 40),
            ["Gradient"] = Color3.fromRGB(100, 180, 255),
            ["Text"] = Color3.fromRGB(240, 240, 255),
            ["Text Stroke"] = Color3.fromRGB(0, 0, 0),
            ["Placeholder Text"] = Color3.fromRGB(160, 170, 180),
    ...
    local function UpdateWatermark()
        ...
        if Items["Text"] and Items["Text"].Instance then
            Items["Text"].Instance.Text = string.format("%s | %d fps | %d ms", Name, fps, ping)
        end
    end
